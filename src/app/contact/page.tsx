export default function Contact() {
  return (
    <section className="max-w-xl w-full mx-auto py-8 sm:py-12 px-4 sm:px-0 text-center">
      <h2 className="text-2xl sm:text-3xl font-bold text-navy-800 mb-6 sm:mb-10">
        Contacto
      </h2>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
        ...
        <a
          ...
          className="flex flex-col items-center justify-center rounded-xl bg-[#0077B5] text-white py-10 sm:py-14 shadow hover:scale-105 transition"
        >
          <svg
            width="48"
            height="48"
          ...
          <span className="font-semibold text-base sm:text-lg">LinkedIn</span>
        </a>
        {/* GitHub */}
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="flex flex-col items-center justify-center rounded-xl bg-[#24292F] text-white py-10 sm:py-14 shadow hover:scale-105 transition"
        >
          <svg
            width="48"
            height="48"
          ...
          <span className="font-semibold text-base sm:text-lg">GitHub</span>
        </a>
        {/* WhatsApp */}
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="flex flex-col items-center justify-center rounded-xl bg-green-700 text-white py-10 sm:py-14 shadow hover:scale-105 transition"
        >
          <svg
            width="48"
            height="48"
        ...
        <a
          ...
          className="flex flex-col items-center justify-center rounded-xl bg-gradient-to-r from-navy-800 to-gray-800 text-white py-10 sm:py-14 shadow hover:scale-105 transition"
        >
          <svg
            width="48"
            height="48"
